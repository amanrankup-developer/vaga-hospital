    ...
    <main className="bg-white">
      ...
      <section className="mx-auto -mt-4 max-w-[1200px] px-6 pb-4 lg:px-10">
        <div className="grid gap-5 sm:grid-cols-3">
          <FadeUp delay={0}>
            <div className="group rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-all duration-500 hover:-translate-y-2 hover:border-sky-300 hover:shadow-[0_25px_70px_-20px_rgba(14,165,233,0.25)]">
              <span className="flex h-11 w-11 items-center justify-center rounded-full bg-sky-100 text-sky-600 transition-all duration-500 group-hover:scale-110 group-hover:rotate-6">
                <Phone size={20} />
              </span>
        ...
        <div className="grid gap-10 lg:grid-cols-2">
          ...
          <FadeRight>
            <div className="flex flex-col gap-6">
              <div className="overflow-hidden rounded-3xl border border-slate-200 shadow-sm transition-shadow duration-500 hover:shadow-lg">
                <iframe
              ...
              <div className="group rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-all duration-300 hover:border-sky-200 hover:shadow-sm">
                <div className="flex items-center gap-3">
                  <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-sky-100 text-sky-600 transition-transform duration-300 group-hover:scale-110">
                    <Clock size={18} />
                  </span>
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 rounded-full bg-sky-600 px-6 py-3.5 text-sm font-semibold text-white shadow-lg shadow-sky-600/20 transition-all duration-300 hover:-translate-y-0.5 hover:bg-sky-700 hover:shadow-xl hover:shadow-sky-600/30"
              >
                Get Directions
              </a>
            </div>
