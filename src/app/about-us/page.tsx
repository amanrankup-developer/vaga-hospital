        ...
        <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
          ...
          <div className="pt-2">
            ...
            <p className="mt-6 leading-relaxed text-slate-600">
              ...
              specialized expertise in Phaco (cataract) surgery using the latest
              technology.
            </p>
        ...
        <div className="mx-auto grid max-w-300 grid-cols-2 gap-8 px-6 sm:grid-cols-4 lg:px-10">
          {stats.map(({ icon: Icon, value, label }) => (
            <div key={label} className="text-center">
              <span className="mx-auto flex h-11 w-11 items-center justify-center rounded-full bg-sky-600/10 text-sky-400">
                <Icon size={20} />
              </span>
        ...
        <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div>
            ...
            <p className="mt-6 leading-relaxed text-slate-600">
              ...
              and valuable experience to our patients. Our healthcare offerings
              are supported by a team of compassionate and dedicated medical
              professionals with rich knowledge and experience across their
              domains.
            </p>
